...
function loading_animation {
    ...
    local dots=""
    while true; do
        echo -ne "${YELLOW}Sedang menambahkan repositori Kartolo${dots}...${RESET}\r"
        sleep $delay
        dots+="."
...
# Menyimpan PID dari proses penambahan repositori
repo_pid=$!
...
# Menunggu proses penambahan repositori selesai
wait $repo_pid
